...
## 設計ドキュメント
[要件定義・基本設計・詳細設計の一覧_Googleスプレッドシート](https://docs.google.com/spreadsheets/d/1X1eVxMKIFJwROTdSe-xkavsRJsfvgtBGdfmgZeLqHu8/edit)
...
## 備考
[ESlintの実行結果_GItHub Actions](https://github.com/amanoyuma/yamamatch/actions/runs/24896570181/job/72902858536)
  - 活用した生成AIとその用途
  ...
  - リファクタリングの規則
    - 変数名で２つ以上の単語が入る場合は、「isPublished」のように二つ目以降の単語の頭を大文字とする。   
